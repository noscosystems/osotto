<?php
    ...
    class IP extends \CComponent
    {
         ...
         * @static
         * @access public
         * @param string $ip        The IP address in either IPv4 or IPv6 format.
         * @param boolean $shrink   By default, a 16-byte string is returned for both IPv4 and IPv6 addresses. By
         *                          passing `true` in this parameter, you can force a return of a 4-byte string for IPv4
         *                          addresses.
         * @return string|false     Returns a 16-byte, or 4-byte, string representation of the provided IP address. This
         *                          method will return false if the IP address could not be converted (for example, if
         *                          it was incorrectly formatted).
         */
        ...
        {
            if((!is_int($cidr) && !preg_match('/^(0|[1-9]\\d{0,2})$/', $cidr)) || $cidr < 0 || $cidr > 128) {
                return false;
            }
            $cidr = (int) $cidr;
