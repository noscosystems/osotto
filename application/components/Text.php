<?php
    ...
    class Text extends \CComponent
    {
        ...
        public static function anglicise($str)
        {
            ...
            $iso88591 = array(
                'single' => array(
                    'in' => chr(128) . chr(131) . chr(138) . chr(142) . chr(154) . chr(158) . chr(159) . chr(162)
            ...
            if(self::isUTF8($str)) {
                ...
                $str = strtr($str, $iso88591['single']['in'], $iso88591['single']['out']);
                $str = str_replace($iso88591['double']['in'], $iso88591['double']['out'], $str);
            }
            return $str;
        }
