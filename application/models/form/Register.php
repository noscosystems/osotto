<?php
    ...
    class Register extends FormModel
    {
        ...
        public $username,$password,$firstname,$middlename,$lastname,$ageGroup,$email,$mobile,$other_number,$country,$county,$town,$postcode,$address1,$address2;
        ...
        public function rules()
        {
            return array(
                ...
                array('other_number', 'match', 'pattern' => '/^0[0-9]{9,10}$/'),
